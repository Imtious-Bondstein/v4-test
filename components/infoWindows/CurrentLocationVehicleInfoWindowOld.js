...
const CurrentLocationVehicleInfoWindowOld = ({
  vehicle,
    ...
    <div className="w-96 absolute bottom-20 -right-36 z-50">
      <div className="px-2 pb-2 pt-6 rounded-xl text-xs flex-col bg-white z-[100]">
        ...
        <div className="grid grid-cols-5 gap-1.5 relative">
          ...
          >
            <Link
              href={`/reports/location?identifier=${vehicle.v_identifier}`}
              id={`action-messenger-${vehicle.v_identifier}`}
              className=""
            >
              <LocationSVG />
            </Link>
          ...
          >
            <Link
              href={`/reports/distance-report/hourly?identifier=${vehicle.v_identifier}`}
              id={`action-messenger-${vehicle.v_identifier}`}
              className=""
            >
              <ClockSVG />
          ...
          >
            <Link
              href={`/reports/engine?identifier=${vehicle.v_identifier}`}
              id={`action-messenger-${vehicle.v_identifier}`}
              className=""
            >
              <EngineReportSVG />
          ...
          >
            <Link
              href={`/activity/alerts/overspeed?identifier=${vehicle.v_identifier}`}
              id={`action-messenger-${vehicle.v_identifier}`}
              className=""
            >
              <SpeedMeterSVG />
          ...
          >
            <Link
              href={`/location/vehicle-route?identifier=${vehicle.v_identifier}`}
              id={`action-messenger-${vehicle.v_identifier}`}
              className=" "
            >
              <RouteSVG />
...
export default CurrentLocationVehicleInfoWindowOld;
