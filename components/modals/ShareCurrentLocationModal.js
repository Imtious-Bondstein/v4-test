...
function ShareCurrentLocationModal({
  selectedVehicles,
  ...
  const generateShareToken = async () => {
    ...
    await axios
      .get(
        `/api/v4/generate-token-current-location?identifier=${selectedVehicle.value}&duration=${selectedDuration.value}`
      )
      .then((res) => {
        ...
        <div className="">
          {!isBack ? (
            ...
            <div>
              ...
              {/* ===== link ===== */}
              <p className="bg-inputGray rounded-xl p-4 text-blue-400 mt-8">
                <Link
...
export default ShareCurrentLocationModal;
