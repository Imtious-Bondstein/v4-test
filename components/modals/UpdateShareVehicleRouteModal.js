...
function UpdateShareVehicleRouteModal({
  selectedVehicles,
  ...
  return (
    <div>
      <Modal
        ...
        style={customStyles}
        className={`absolute sm:w-[450px] w-[320px] h-[385px]  p-5 bg-white`}
        ...
        <div className="">
          {!isBack ? (
            <div>
              ...
              <div className="mt-4">
                {/* BSTID */}
                {selectedVehicles.map(({ bst_id, activeStatus }, index) => {
                  return (
                    <div key={index}>
...
export default UpdateShareVehicleRouteModal;
