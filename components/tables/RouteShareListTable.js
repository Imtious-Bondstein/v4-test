...
import {
  routeShareListDateTime,
  shareLinkDateTime,
  shareLinkDateTimeCheck,
  shareLinkDateTimeTest,
} from "@/utils/dateTimeConverter";
import UpdateShareVehicleRouteModal from "../modals/UpdateShareVehicleRouteModal";
import EditTableMobileSVG from "../SVG/table/EditTableMobileSVG";
import CrossSVG from "@/svg/CrossSVG";
import axios from "@/plugins/axios";

const RouteShareListTable = ({
  isLoading,
  setIsLoading,
  setSearchKey,
  searchKey,
  ...
  const initData = () => {
    const newState = routeShareData.map((item, index) => ({
      ...item,
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-5 text-base text-primaryText hidden md:table-cell">
                          {routeShareListDateTime(start_time)}
                        </td>

                        {/* EXPIRY TIME */}
                        <td className="px-5 text-base text-primaryText hidden md:table-cell">
                          {routeShareListDateTime(expire_time)}
                        </td>
                        ...
                        >
                          ...
                          {displayDropdownInfo === true ? (
                            <div className="flex flex-col space-y-2">
                              ...
                              <div className="flex items-center text-tertiaryText text-sm font-medium">
                                <p>Start Time:&nbsp;</p>
                                <p>{routeShareListDateTime(start_time)}</p>
                              </div>
                              <div className="flex items-center text-tertiaryText text-sm font-medium">
                                <p>Expiry Time:&nbsp;</p>
                                <p>{routeShareListDateTime(expire_time)}</p>
                              </div>
                              <div className="flex items-center text-tertiaryText text-sm font-medium">
                                <p>Actions:&nbsp;</p>
...
export default RouteShareListTable;
