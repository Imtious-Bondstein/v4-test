...
const AnalyticsSummaryMultipleVehicleSelector = ({
  setIsVehicleSelectorLoading,
  isSelected,
  isRequesting,
  ...
  useEffect(() => {
    ...
    if (!isStoreLoading && storeVehicleLists) {
      ...
      setIsVehicleSelectorLoading(isStoreLoading);
    }
  }, [isStoreLoading]);
  ...
  return (
    <div className={`${top === true ? "top-5 lg:top-16" : ""} relative`}>
      <div className="relative w-[327px] h-[64vh] min-h-[500px] rounded-xl bg-white p-4 overflow-hidden">
...
export default AnalyticsSummaryMultipleVehicleSelector;
