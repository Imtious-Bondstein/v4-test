...
const DateRangeMultipleVehicleSelector = ({
  isSelected,
  isRequesting,
  ...
  return (
    <div className="relative w-[327px] rounded-xl bg-white  p-4 h-[74.3vh] overflow-hidden">
      ...
      <div className="h-[120px]">
        ...
        <div className="flex items-center space-x-4 mt-4  ">
          <div className="relative bg-white tmv-shadow rounded-xl w-full">
            <div className="h-[45px] flex items-center">
              <DatePicker
                selected={dateRange.startDate}
                onChange={(date) => handleStartTime(date, "startDate")}
                dateFormat="dd/MM/yyyy"
                className="w-full p-3 bg-white text-xs font-bold placeholder:text-tertiaryText rounded-xl z-40 outline-quaternary"
...
export default DateRangeMultipleVehicleSelector;
