...
const ReportSingleVehicleSelector = ({
  isRequesting,
  ...
  return (
    <div className="relative lg:top-24 lg:-mt-1 w-[327px] h-[75vh] rounded-xl bg-white p-4 overflow-hidden">
      <div className="h-[170px] absolute top-5 left-0 w-full px-4">
      ...
      {isLoading ? (
        ...
        <div className="calc-height-220 mt-[190px] overflow-y-scroll pr-3.5 select-none scrollGray">
...
export default ReportSingleVehicleSelector;
