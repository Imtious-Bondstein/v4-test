...
import CurrentLocationMapNew from "@/components/maps/CurrentLocationMapNew";

const current_location_new = () => {
...
export default current_location_new;

current_location_new.getLayout = function getLayout(page) {
  return (
    <ProtectedRoute>
      <Layout>
